...
module.exports = {
  ...
  theme: {
    extend: {
      keyframes: {
        //flashGreen effects are used to indicate a correct guess for a click event; the flahsRed effect is used to indicate an incorrect
        ...
        //alternate from one version of flashGreen animation to the other. There is no need for a second flashRed animation as it is 
