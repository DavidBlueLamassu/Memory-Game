...
module.exports = {
  ...
  theme: {
    extend: {
      keyframes: {
        //flashGreen effects are used to indicate a correct guess for a click event; the flashRed effect is used to indicate an incorrect
        //guess. Two animations are used for green as each is set to flash only once upon a change of state (resulting from a click 
        //event). Accordingly, as no effect will arise without changing to a new animation there is conditional code in Game.js to
        //alternate from one version of the flashGreen animation to the other. There is no need for a second flashRed animation as it is 
        //not possible to make two incorrect guesses back-to-back. Each animation lasts one second (see animation key below) and 
        ...
        //The shake effect is used to emphasize that the user has chosen a wrong answer in conjunction with the flashRed animation. Upon
        //clicking an incorrect answer the div containing image cards will move 20px to the left and right four times over a period of one 
        ...
        //be re-activated upon a change of state generated by a click event. Conditional code in Game.js allows an alternation between
        //the two effects. The code for these effects is based upon the "headShake" animation from: Nidhi D, "TailwindCSS -- How to Design
        //Custom Animations", Canopas (30 June 2022), last viewed 15 May 2023: 
        ...
        //It is used for both main title elements ("MEMORY" and "MATCH"). The code for this effect is based upon the "heartBeat" 
        //animation from: Nidhi D, "TailwindCSS -- How to Design Custom Animations", Canopas (30 June 2022), last viewed 15 May 2023: 
        //https://blog.canopas.com/tailwind-css-custom-animations-b041a1310aab
        textGrow: {
        ...
        //to be used in conjunction with textGrow so that one part of the title expands first followed by the second. Like textGrow
        ...
        //last viewed 15 May 2023: https://blog.canopas.com/tailwind-css-custom-animations-b041a1310aab
        textGrow2: {
          '0%': {transform: 'scale(0.1)'},
          '0%': {color: 'black'},
        ...
        //red to blue to green). The full animation takes 60 seconds to run and is currently set to infinite iterations (see animation 
        ...
        //2022), last viewed 15 May 2023: https://blog.canopas.com/tailwind-css-custom-animations-b041a1310aab and from the "waving-hand"
        ...
        //This effect continuously rotates an element on its axis. It is used to rotate the React spinner symbol at the bottom of 
        //Game.js. The code for this animation is derived from from the "wiggle" animation from Nidhi D, "TailwindCSS -- How
        //to Design Custom Animations", Canopas (30 June 2022), last viewed 15 May 2023: 
        //https://blog.canopas.com/tailwind-css-custom-animations-b041a1310aab and also from: Anees Asghar, "How to Rotate Animation 
        //in CSS", Linux Hint (2022), last viewed 15 May 2023: https://linuxhint.com/rotate-animation-css/
        rotation: {
