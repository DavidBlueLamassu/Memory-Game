  ...
  theme: {
    extend: {
      keyframes: {
        ...
        // flashes from white to color and back to white.
        flashGreen: {
          '50%': { color: 'green' },
        },
        flashGreenTwo: {
        ...
        //It is used for both main title elements ("MEMORY" and "GAME"). 
        textGrow: {
        ...
        //this animation lasts 5 seconds and undergoes only one iteration (see animation key below).
        textGrow2: {
          '0%': {transform: 'scale(0.1)'},
          '0%': {color: 'black'},
